...
return new_image;};DynamicManager.prototype.loadImage=function(src){var image;image=void 0;if(!($("#overlay_me_images_container #"+this.image_id).length>0)){image=new OverlayMe.Overlays.Image(src,{destroyable:true,default_css:{visibility:'visible'}});OverlayMe.images_management_div.append(image.render());}
