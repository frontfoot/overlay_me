(function() {
  ...
  describe("Menu", function() {
    it("should have the menu view accessible via the OverlayMe namespace", function() {
    ...
    it("should be an appendable list of MenuItems", function() {
      var test_li;
    ...
    it("should changed of location when dragged", function() {
