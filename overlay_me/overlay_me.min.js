...
$(this.el).bind('mousedown',function(event){return _this.toggleMove(event);});$(window).bind('mouseup',function(event){return _this.endMove(event);});$(this.el).bind('mouseover',function(event){return $(".overlay-image-block[data-img-id="+_this.id+"]").addClass('hovered');});$(this.el).bind('mouseout',function(event){return $(".overlay-image-block[data-img-id="+_this.id+"]").removeClass('hovered');});return $(window).bind('images_should_be_rendred',function(event){return setTimeout(function(){return _this.fitDivToImage();},500);});};DraggableImage.prototype.fitDivToImage=function(){if(this.image.width>0){$(this.el).css('width',this.image.width);return $(this.el).css('height',this.image.height);}};DraggableImage.prototype.render=function(){return this.el;};return DraggableImage;})(OverlayMe.Draggable);}).call(this);(function(){var __hasProp={}.hasOwnProperty,__extends=function(child,parent){for(var key in parent){if(__hasProp.call(parent,key))child[key]=parent[key];}function ctor(){this.constructor=child;}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child;};OverlayMe.Overlays.Image=(function(_super){__extends(Image,_super);Image.name='Image';function Image(){return Image.__super__.constructor.apply(this,arguments);}
Image.prototype.tagName='div';Image.prototype.className='overlay-image-block';Image.prototype.initialize=function(image_src,options){var slider_block;if(options==null){options={destroyable:false};}
this.image_src=image_src;this.image_id=image_src.replace(/[.:\/]/g,'_').replace(/[^a-zA-Z0-9_\-]/g,'');$(this.el).attr('data-img-id',this.image_id);this.images_container=$('#images_container');if(this.images_container.length<1){$('body').append((new Backbone.View).make('div',{id:'images_container'}));this.images_container=$('#images_container');}
...
$(this.el).append(this.checkbox());$(this.el).append(this.label());slider_block=this.make('div',{"class":'slider-block'});$(this.el).append(slider_block);slider_block.appendChild(this.make('label',{},'Opacity'));slider_block.appendChild(this.slider());if(options.destroyable){return $(this.el).append(this.delButton());}};Image.prototype.image=function(){this.image=new OverlayMe.Overlays.DraggableImage({id:this.image_id},{image_src:this.image_src,default_css:this.default_css});return this.image.render();};Image.prototype.checkbox=function(){var _this=this;this.checkbox=this.make('input',{type:"checkbox"});if($(this.image.el).css('visibility')==='visible'){this.checkbox.checked=true;}
$(this.checkbox).bind('change',function(event){return _this.flickVisibility();});return this.checkbox;};Image.prototype.delButton=function(){var _this=this;this.delButton=this.make('button',{"class":'del-button',title:'Delete'},'x');$(this.delButton).bind('click',function(e){return OverlayMe.dyn_manager.delImage(_this.image_id);});return this.delButton;};Image.prototype.flickCheckbox=function(){this.checkbox.checked=!this.checkbox.checked;return this.flickVisibility();};Image.prototype.flickVisibility=function(){if(this.checkbox.checked){$(this.image.el).css('visibility','visible');}else{$(this.image.el).css('visibility','hidden');}
return this.image.saveCss();};Image.prototype.label=function(){var _this=this;this.label=this.make('label',{},this.image_src.replace(/.*\//,''));$(this.label).bind('mouseover',function(event){$(_this.image.el).css('opacity',1);return $(_this.image.el).addClass('highlight');});$(this.label).bind('mouseout',function(event){$(_this.image.el).removeClass('highlight');return $(_this.image.el).css('opacity',$(_this.slider)[0].value/100);});return $(this.label).bind('click',function(event){return _this.flickCheckbox();});};Image.prototype.slider=function(){var _this=this;this.slider=this.make('input',{type:"range",value:$(this.image.el).css('opacity')*100});$(this.slider).bind('change',function(){$(_this.image.el).css('opacity',$(_this.slider)[0].value/100);return _this.image.saveCss();});return this.slider;};Image.prototype.render=function(){return this.el;};return Image;})(Backbone.View);}).call(this);(function(){var __hasProp={}.hasOwnProperty,__extends=function(child,parent){for(var key in parent){if(__hasProp.call(parent,key))child[key]=parent[key];}function ctor(){this.constructor=child;}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child;};OverlayMe.Overlays.DynamicManager=(function(_super){__extends(DynamicManager,_super);DynamicManager.name='DynamicManager';function DynamicManager(){return DynamicManager.__super__.constructor.apply(this,arguments);}
...
return false;};DynamicManager.prototype.isEmpty=function(){return this.list.length===0;};DynamicManager.prototype.addImage=function(src){var new_image;new_image=this.loadImage(src);if(!this.isPresent(new_image.image_id)){this.list.push({id:new_image.image_id,src:new_image.image_src});this.saveList();}
return new_image;};DynamicManager.prototype.loadImage=function(src){var image;image=void 0;if(!($("#images_container #"+this.image_id).length>0)){image=new OverlayMe.Overlays.Image(src,{destroyable:true,default_css:{visibility:'visible'}});OverlayMe.images_management_div.append(image.render());}
