  ...
  OverlayMe.Draggable = (function(_super) {
    ...
    Draggable.prototype.initialize = function(attributes, options) {
      ...
      if ((cssData = localStorage.getItem(this.id))) {
        $(this.el).css(JSON.parse(cssData));
      } else {
        if (options.default_css !== void 0) {
          $(this.el).css(options.default_css);
        }
      }
      return _.each(options.events_to_save_on, function(event_name) {
        return $(window).bind(event_name, function() {
          return _this.saveCss();
        });
      });
    };
...
(function() {
  ...
  if (!navigator.userAgent.match(/(iPhone|iPod|iPad|Android)/)) {
    ...
    $(drag_me_line).bind('mousedown', function(event) {
      return menu_box.toggleMove(event);
    });
    $(window).bind('mouseup', function(event) {
      return menu_box.endMove(event);
    });
  }
...
(function() {
  ...
  if (!navigator.userAgent.match(/(iPhone|iPod|iPad|Android)/)) {
    window.toggle_menu_visibility = function() {
      ...
      $(menu).css(css);
      return $(window).trigger('save:menu');
    };
...
(function() {
  ...
  OverlayMe.Overlays.DraggableImage = (function(_super) {
    ...
    DraggableImage.prototype.initialize = function(attributes, options) {
      ...
      return $(window).bind('images_should_be_rendred', function(event) {
...
(function() {
  ...
  OverlayMe.Overlays.Image = (function(_super) {
    ...
    Image.prototype.initialize = function(image_src, options) {
      ...
      this.image_id = image_src.replace(/[.:\/]/g, '_').replace(/[^a-zA-Z0-9_\-]/g, '');
      ...
      if (options.destroyable) {
        return $(this.el).append(this.delButton());
      }
    };
    ...
    Image.prototype.checkbox = function() {
      ...
      $(this.checkbox).bind('change', function(event) {
    ...
    Image.prototype.label = function() {
      var _this = this;
      this.label = this.make('label', {}, this.image_src.replace(/.*\//, ''));
      $(this.label).bind('mouseover', function(event) {
        $(_this.image.el).css('opacity', 1);
        return $(_this.image.el).addClass('highlight');
      });
      $(this.label).bind('mouseout', function(event) {
        $(_this.image.el).removeClass('highlight');
        return $(_this.image.el).css('opacity', $(_this.slider)[0].value / 100);
      });
      return $(this.label).bind('click', function(event) {
    ...
    Image.prototype.slider = function() {
      ...
      $(this.slider).bind('change', function() {
...
(function() {
  ...
  OverlayMe.Overlays.DynamicManager = (function(_super) {
    ...
    DynamicManager.prototype.addImage = function(src) {
      var new_image;
      new_image = this.loadImage(src);
      if (!this.isPresent(new_image.image_id)) {
        this.list.push({
    ...
    DynamicManager.prototype.loadImage = function(src) {
      var image;
      image = void 0;
      if (!($("#images_container #" + this.image_id).length > 0)) {
...
(function() {
  ...
  OverlayMe.Overlays.ContentDivManagementBlock = (function(_super) {
    ...
    ContentDivManagementBlock.prototype.container_id = 'container';
    ...
    ContentDivManagementBlock.prototype.initialize = function() {
      var contentCss, slider_block;
      if ($('#content').length !== 0) {
        this.container_id = 'content';
      }
      $("#" + this.container_id).css({
        'z-index': this.normal_zindex
      });
      if ((contentCss = localStorage.getItem("#" + this.container_id))) {
        $("#" + this.container_id).css(JSON.parse(contentCss));
      }
    ...
    ContentDivManagementBlock.prototype.zIndexSwitch = function() {
      ...
      if ($("#" + this.container_id).css('z-index') === this.over_zindex) {
        this.zIndexSwitch.checked = true;
      }
      label = this.make('label', {}, 'HTML on top (touch "D")');
      dToSwap = this.make('p', {}, 'Will swap the z-index of the main content');
      $(block).append(label);
      return $(block).append(dToSwap);
    };
    ...
    ContentDivManagementBlock.prototype.contentSlider = function() {
      return this.contentSlider = this.make('input', {
        id: "contentSlider",
        type: "range",
        value: $("#" + this.container_id).css('opacity') * 100
      });
    };
    ...
    ContentDivManagementBlock.prototype.saveContentCss = function() {
      return localStorage.setItem("#" + this.container_id, JSON.stringify({
        opacity: $("#" + this.container_id).css('opacity'),
        'z-index': $("#" + this.container_id).css('z-index')
      }));
    };
...
(function() {
  ...
  OverlayMe.Overlays.ImagesManagementDiv = (function(_super) {
    ...
    ImagesManagementDiv.prototype.initialize = function() {
      ...
      this.controlBlock.appendChild(this.make('label', {}, 'All/None'));
      this.controlBlock.appendChild(this.hideInactiveBox());
      this.controlBlock.appendChild(this.make('label', {}, 'Hide Inactives'));
    ...
    ImagesManagementDiv.prototype.del = function(image_id) {
      ...
      return $("#images_container #" + image_id).remove();
    };

    ImagesManagementDiv.prototype.dynamicAddsBlock = function() {
      var image_text_input,
        _this = this;
      this.dynamicAddsBlock = this.make('div', {
        "class": 'dynamic-adds'
      });
      this.dynamicAddsBlock.appendChild(this.make('label', {}, 'Add an image'));
      image_text_input = this.make('input', {
        type: 'text',
        placeholder: "http://"
      });
      this.dynamicAddsBlock.appendChild(image_text_input);
      $(image_text_input).bind('keypress', function(e) {
        if (e.keyCode === 13) {
          OverlayMe.dyn_manager.addImage(e.target.value);
          return e.target.value = '';
        }
      });
      return this.dynamicAddsBlock;
    };

    ImagesManagementDiv.prototype.hideInactiveBox = function() {
      var _this = this;
      this.hideInactiveBox = this.make('input', {
        type: "checkbox",
        "class": 'hide-inactive'
      });
      if ($(this.hideInactiveBox).css('visibility') === 'visible') {
        this.hideInactiveBox.checked = true;
      }
      $(this.hideInactiveBox).bind('change', function(event) {
        _this.hideInactive(_this.hideInactiveBox.checked);
        return _this.saveState();
      });
      return this.hideInactiveBox;
    };

    ImagesManagementDiv.prototype.hideInactive = function(state) {
      return _.each($('.overlay-image-block'), function(img_block) {
        var checkbox, img_id;
        checkbox = $('input[type=checkbox]', img_block);
        img_id = $(img_block).attr('data-img-id');
        if (state && !checkbox.first()[0].checked) {
          $(img_block).hide();
          return $("#" + img_id).hide();
        } else {
          $(img_block).show();
    ...
    ImagesManagementDiv.prototype.checkAllbox = function() {
      ...
      $(this.checkAllBox).bind('change', function(event) {
        _this.checkAll(_this.checkAllBox.checked);
        return _this.saveState();
      });
      return this.checkAllBox;
    };

    ImagesManagementDiv.prototype.checkAll = function(state) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (checkbox.checked !== state) {
          _results.push($(checkbox).trigger('click'));
        } else {
...
(function() {
  ...
  if (!navigator.userAgent.match(/(iPhone|iPod|iPad|Android)/)) {
    ...
    $.getJSON('/overlay_images', function(data) {
...
(function() {
  ...
  head.appendChild(createTag('link', {
    type: 'text/css',
    href: 'https://raw.github.com/frontfoot/overlay_me/master/overlay_me.css',
    media: 'only screen',
    rel: 'stylesheet'
  }));
