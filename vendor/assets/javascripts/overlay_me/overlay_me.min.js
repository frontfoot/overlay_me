...
if(tree.files){_ref1=tree.files;_results=[];for(_j=0,_len1=_ref1.length;_j<_len1;_j++){img=_ref1[_j];console.log(tree.parent_path+img);_results.push(parent.append(new OverlayMe.Overlays.Image(tree.parent_path+img).render()));}
