...
this.default_css=$.extend({display:'none',opacity:0.5},options.default_css);if(!($o("#"+this.image_id,this.images_container).length>0)){$o(this.images_container).append(this.image());}
...
image_id=OverlayMe.Overlays.urlToId(src);if(!($o("#overlay_me_images_container #"+image_id).length>0)){_default_css=$.extend({display:'block'},options.default_css);image=new OverlayMe.Overlays.Image(src,{destroyable:true,default_css:_default_css});OverlayMe.images_management_div.append(image.render());}
