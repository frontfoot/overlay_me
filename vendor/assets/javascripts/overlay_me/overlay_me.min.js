...
if(event.charCode===114){return OverlayMe.clearAndReload();}});}}).call(this);(function(){OverlayMe.Overlays={};OverlayMe.Overlays.urlToId=function(url){return url.replace(/[.:\/]/g,'_').replace(/[^a-zA-Z0-9_\-]/g,'');};OverlayMe.Overlays.pathToClasses=function(path){return _.without(path.split('/'),'').join(' ');};OverlayMe.unicorns=["http://fc07.deviantart.net/fs49/f/2009/200/b/3/Fat_Unicorn_and_the_Rainbow_by_la_ratta.jpg","http://www.deviantart.com/download/126388773/Unicorn_Pukes_Rainbow_by_Angel35W.jpg","http://macmcrae.com/wp-content/uploads/2010/02/unicorn.jpg","http://4.bp.blogspot.com/-uPLiez-m9vY/TacC_Bmsn3I/AAAAAAAAAyg/jusQIA8aAME/s1600/Behold_A_Rainbow_Unicorn_Ninja_by_Jess4921.jpg","http://www.everquestdragon.com/everquestdragon/main/image.axd?picture=2009%2F9%2FPaperPaperNewrainbow.png"];}).call(this);(function(){var __hasProp={}.hasOwnProperty,__extends=function(child,parent){for(var key in parent){if(__hasProp.call(parent,key))child[key]=parent[key];}function ctor(){this.constructor=child;}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child;};OverlayMe.Overlays.ImagesContainer=(function(_super){__extends(ImagesContainer,_super);ImagesContainer.name='ImagesContainer';function ImagesContainer(){return ImagesContainer.__super__.constructor.apply(this,arguments);}
ImagesContainer.prototype.css_attributes_to_save=['display'];ImagesContainer.prototype.initialize=function(options){var path_classes,sub_container,_this=this;if(!OverlayMe.images_container){OverlayMe.images_container=this.make('div');$o('body').append(OverlayMe.images_container);$o(window).bind('overlay_me:toggle_all_display',function(){return OverlayMe.images_container.toggleDisplay();});}
this.el=OverlayMe.images_container;this.id='overlay_me_images_container';this.loadCss();if(options.parent_path){path_classes=OverlayMe.Overlays.pathToClasses(options.parent_path);sub_container=$o('#overlay_me_images_container '+path_classes.replace(/\ ?(\w+)/g,'.$1'));this.el=sub_container;this.id=OverlayMe.Overlays.urlToId(options.parent_path);if(sub_container.length<1){sub_container=this.make('div',{"class":path_classes});$o(OverlayMe.images_container).append(sub_container);this.el=sub_container;this.id=OverlayMe.Overlays.urlToId(options.parent_path);this.loadCss();$o(window).bind('overlay_me:toggle_img_container',function(event,options){if(_.include(path_classes.split(' '),options["class"])){if(options.show){return _this.show();}else{return _this.hide();}}});}
return sub_container;}
return OverlayMe.images_container;};return ImagesContainer;})(Backbone.View);_.extend(OverlayMe.Overlays.ImagesContainer.prototype,OverlayMe.Mixin.Storable);_.extend(OverlayMe.Overlays.ImagesContainer.prototype,OverlayMe.Mixin.Hideable);}).call(this);(function(){var __hasProp={}.hasOwnProperty,__extends=function(child,parent){for(var key in parent){if(__hasProp.call(parent,key))child[key]=parent[key];}function ctor(){this.constructor=child;}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child;};OverlayMe.Overlays.DraggableImage=(function(_super){__extends(DraggableImage,_super);DraggableImage.name='DraggableImage';function DraggableImage(){return DraggableImage.__super__.constructor.apply(this,arguments);}
