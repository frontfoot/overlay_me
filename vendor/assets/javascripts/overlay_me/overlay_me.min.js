...
ImagesContainer.prototype.css_attributes_to_save=['display'];ImagesContainer.prototype.initialize=function(options){var _this=this;if(!OverlayMe.images_container){OverlayMe.images_container=this.make('div',{id:'overlay_me_images_container'});$o('body').append(OverlayMe.images_container);$o(window).bind('overlay_me:toggle_all_display',function(){return _this.toggleDisplay();});}
this.el=OverlayMe.images_container;this.id='overlay_me_images_container';this.loadCss();if(options.parent_path){return this.subDirContainer(options.parent_path);}
return OverlayMe.images_container;};ImagesContainer.prototype.subDirContainer=function(path,done_bits){var path_bits,sub_container,sub_container_parent_post_string,the_dir,_this=this;if(done_bits==null){done_bits=[];}
